    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between"> 
            ...
            <div className='bg-gray-100 dark:bg-gray-600 sticky bottom-0 w-full justify-center pb-5 pt-2 mx-72'>
                <form className="z-10 px-96" onSubmit={handleSubmit}>
                ...
                <p className='px-96'>Free Research Preview. PuoGPT may produce inaccurate information about people, places, or facts. PuoGPT September 25 Version</p>
            </div>
        </main>
    );
}
